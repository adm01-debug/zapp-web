...
const ROLE_LABELS = {
  admin: { label: 'Administrador', color: 'bg-destructive/10 text-red-800 dark:bg-red-900/30 dark:text-destructive' },
  supervisor: { label: 'Supervisor', color: 'bg-info/10 text-blue-800 dark:bg-blue-900/30 dark:text-info' },
  agent: { label: 'Agente', color: 'bg-success/10 text-green-800 dark:bg-green-900/30 dark:text-success' }
};
