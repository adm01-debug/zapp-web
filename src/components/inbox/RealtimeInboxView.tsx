...
export function RealtimeInboxView() {
  ...
  return (
    <div className="relative h-full w-full bg-[hsl(var(--chat-wallpaper,var(--background)))]">
      {!isMobile && <div className="absolute inset-x-0 top-0 h-32 bg-primary" />}
      ...
      <div className={cn('relative z-10 h-full', !isMobile && 'p-4 md:p-5')}>
        <div
          className={cn(
            'h-full w-full overflow-hidden',
            !isMobile && 'mx-auto max-w-[1600px] border border-border bg-card shadow-xl'
          )}
        >
          <div className="flex h-full min-w-0">
            ...
            <div
              className={cn(
                ...
                isMobile ? 'w-full min-w-0' : 'w-[420px] min-w-[340px] max-w-[500px] flex-shrink-0'
              )}
            >
              {selectionMode && (
                <BulkActionsToolbar
              ...
              <div className="flex items-center justify-between px-4 py-2.5 bg-[hsl(var(--sidebar-header,var(--chat-header)))] border-b border-border">
              ...
              <div className="px-2 py-1.5 bg-card border-b border-border/80">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="h-[35px] pl-10 pr-10 bg-input border-0 rounded-lg text-sm cursor-pointer"
                    readOnly
                  />
                  <Button
                    variant="ghost"
            ...
            {/* RIGHT PANEL */}
            <div className={cn('flex-1 min-w-0', isMobile && !legacyConversation && 'hidden')}>
              {legacyConversation ? (
                ...
                <div className="h-full flex flex-col items-center justify-center whatsapp-chat-wallpaper border-l border-border">
                  <div className="text-center max-w-md px-8">
                    <div className="w-[320px] h-[188px] mx-auto mb-8 flex items-center justify-center text-muted-foreground/30">
                      <svg viewBox="0 0 303 172" width="303" height="172" fill="currentColor" aria-hidden="true">
                    ...
                    <h1 className="text-[32px] font-light text-foreground mb-3 leading-tight">WhatsApp Web</h1>
                    ...
                    <div className="flex items-center justify-center gap-2 text-muted-foreground/70">
                      ...
                      <span className="text-xs">Criptografia de ponta a ponta</span>
                    </div>
                  </div>
                </div>
              )}
