...
const PHASE_META: Record<VoiceAgentPhase, { title: string; subtitle: string }> = {
  ...
  listening: { title: 'Ouvindo...', subtitle: 'Fale seu comando' },
  processing: { title: 'Processando...', subtitle: 'Analisando seu comando' },
  speaking: { title: 'Respondendo', subtitle: 'Ouvindo a resposta' },
  error: { title: 'Erro', subtitle: 'Algo deu errado' },
};
    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          style={{ backgroundColor: 'rgba(8, 8, 18, 0.95)', backdropFilter: 'blur(20px)' }}
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-white/40 mt-1">{meta.subtitle}</p>
          </div>
          ...
          <button
            ...
            aria-label={phase === 'listening' ? 'Parar de ouvir' : 'Começar a ouvir'}
          >
          ...
          {/* Transcript area */}
          <div className="w-full min-h-[60px] space-y-2">
                ...
                <div className="grid grid-cols-2 gap-1.5">
                  {SUGGESTION_COMMANDS.map((cmd, i) => (
                    <motion.div
                      ...
                      className="text-[10px] text-white/30 px-2 py-1.5 rounded-lg bg-white/[0.03] border border-white/[0.05] text-center"
                    >
                      {cmd}
                    </motion.div>
                  ))}
          ...
          <div className="flex items-center justify-between w-full">
            <span className="text-[10px] text-white/20">ESC para fechar</span>
            <button
              onClick={onClose}
